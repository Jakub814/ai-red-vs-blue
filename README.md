...
## Overview
AI Red vs Blue is a safe cybersecurity simulation platform developed as a Final Year Project prototype. It models the interaction between a Red Team and a Blue Team in a controlled environment, where the Red Team generates synthetic phishing-style messages and the Blue Team classifies them using a trained machine-learning model.
...
- Machine-learning-based Blue Team detection using a trained phishing classifier
...
- Filtered result review in the dashboard
